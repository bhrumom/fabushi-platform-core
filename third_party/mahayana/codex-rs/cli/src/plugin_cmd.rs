...
#[derive(Debug, Parser)]
#[command(bin_name = "mahayana plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "mahayana plugin add",
    after_help = "Examples:\n  mahayana plugin add sample@debug\n  mahayana plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "mahayana plugin list",
    after_help = "Examples:\n  mahayana plugin list\n  mahayana plugin list --marketplace debug\n  mahayana plugin list --json\n  mahayana plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "mahayana plugin remove",
    after_help = "Examples:\n  mahayana plugin remove sample@debug\n  mahayana plugin remove sample --marketplace debug"
)]
