//! Captures how this Mahayana process was launched.
//!
...
/// Builds the process provenance row for the current Mahayana executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Mahayana package.");
    }
    check
}
