...
const APP_TOOLTIP: &str = "Try the **Codex App**. Run 'mahayana app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex App**. Run 'mahayana app' or visit https://chatgpt.com/codex?app-landing-page=true";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("mahayana app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting Mahayana.
